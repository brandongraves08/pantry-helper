...
A battery-powered, event-driven pantry inventory system using ESP32 camera, OpenAI Vision or a local/self-hosted provider (OpenClaw, NVIDIA NIM, Ollama) AI, and a Python backend.

> **Status:** ✅ Core system complete and ready for development
> 
> **Vision AI:** Supports OpenAI GPT-4 Vision and other providers (OpenClaw, NVIDIA NIM, Ollama)
>
...
- **Vision AI**: Choose between OpenAI GPT-4 Vision or a self-hosted provider for image analysis
...
# Edit .env with your API key (OPENAI_API_KEY or vision provider_API_KEY)
...
echo "vision provider_API_KEY=your-vision provider-key-here" >> backend/.env
...
**Option 2: self-hosted / local providers (Ollama, OpenClaw gateway)**
- No per-image cost — runs on your own hardware
