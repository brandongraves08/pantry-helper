...
from app.api.routes import shopping, reviews, captures, zones, household, barcode, detections, nutrition, recipes, meal_plans
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://pantry-helper.thelab.lan:3000", "http://localhost:3000", "http://127.0.0.1:3000"],
